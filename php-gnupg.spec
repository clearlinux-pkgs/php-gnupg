...
Source0  : https://pecl.php.net/get/gnupg-1.5.3.tgz
...
%prep
%setup -q -n gnupg-1.5.3
cd %{_builddir}/gnupg-1.5.3
pushd ..
cp -a gnupg-1.5.3 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/extensions/no-debug-non-zts-20240924/gnupg.so
